  ...
  return (
    <div>
      <div className='absolute top-0 left-0 h-full w-full p-6 flex flex-col justify-between leading-tight'>
        ...
        <div>
            <p className='text-white text-xm mb-8 font-semibold leading-tight'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eligendi distinctio consequuntur, voluptatum debitis minus explicabo!</p>
            <div>
